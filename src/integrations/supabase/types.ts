...
export type Database = {
  _analytics: {
    Tables: {
      ...
      log_events_0a30c616_c023_4c9d_9bbe_a5863460511e: {
        Row: {
          body: Json | null
      ...
      log_events_179ea7a9_0490_4b76_86c1_4cda5c243fbb: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_4884f916_06ba_4ccd_a704_c624cde9b71a: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_93c95f6b_c1fb_4de9_a63e_7d4db2937e59: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_ab9725c2_c7e1_4c3b_b166_68fa29e4ecbb: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_ace2e1d6_d0b3_42ed_8dbf_bd08aceecae4: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_b62a9213_46aa_4c74_b7df_92268dd01aab: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_e3efde6d_f468_4651_870c_f365c3c9e212: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_e4882d56_dde7_43d2_add7_6d8df21db913: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
  ...
  public: {
    Tables: {
      alvara_bombeiros: {
        ...
        Relationships: [
          {
            foreignKeyName: "alvara_bombeiros_company_id_fkey"
            columns: ["company_id"]
      ...
      alvara_sanitario: {
        ...
        Relationships: [
          {
            foreignKeyName: "alvara_sanitario_company_id_fkey"
            columns: ["company_id"]
            referencedRelation: "companies"
            referencedColumns: ["id"]
          },
      ...
      department_submenus: {
        ...
        Relationships: [
          {
            foreignKeyName: "department_submenus_department_id_fkey"
            columns: ["department_id"]
            referencedRelation: "departments"
            referencedColumns: ["id"]
          },
