...
/** Recursos (módulos) de Nota Fiscal — novos módulos entram nesta lista. */
const MODULES = [
...
export default function NotaFiscalPanel() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <PanelHeader title="Nota Fiscal" subtitle="Painel do departamento" />
      ...
      <main className="mx-auto w-full max-w-[1600px] flex-1 px-4 py-8 sm:px-6">
        <ModuleNav
          ...
          active={active}
          onSelect={setActive}
          ariaLabel="Recursos de Nota Fiscal"
        />

        {active === "dashboard" && (
          <DepartmentDashboard title="Nota Fiscal" />
        )}
      </main>
    </div>
  );
