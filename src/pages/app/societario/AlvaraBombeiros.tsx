...
import type { AlvaraBombeirosInput } from "@/lib/types";

const STORAGE_KEY = "societario:alvara-bombeiros-ano";
...
export default function AlvaraBombeiros() {
  ...
  const saveMutation = useSaveAlvaraBombeiros(ano);
    ...
    saveMutation.mutate(
      {
        ...
        ...patch,
      } as unknown as AlvaraBombeirosInput,
      {
        onError: (error) => {
          toast.error(
          ...
          <Table className="table-fixed min-w-[1240px]">
            <TableHeader>
              <TableRow className="bg-muted hover:bg-muted">
                ...
                {renderFilterSelect("gerado", "Gerado", ALVARA_BOMBEIROS_GERADO_OPTIONS, "w-24")}
                {renderFilterSelect(
                  "enviado",
                  "Enviado",
                  ALVARA_BOMBEIROS_ENVIADO_OPTIONS,
